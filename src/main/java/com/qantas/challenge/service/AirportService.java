...
public class AirportService {
    ...
    AirportDto transformToDto(QantasApiAirport source) {
        ...
        return AirportDto.builder()
                ...
                .stateCode(source.getCity().getState() != null ? source.getCity().getState().getStateCode() : null)
                .stateName(source.getCity().getState() != null ? source.getCity().getState().getStateName() : null)
